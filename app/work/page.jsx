...
const projects = [
    {
        ...
        category: "Frontend",
        title: "Sahtak ai",
        description: "Developed an AI-powered platform using Next.js (App Router) with TypeScript and Tailwind CSS for responsive design.Integrated OpenAI API for NLP features, smart scheduling, and dynamic response generation.Implemented SSR/SSG for SEO optimization and Next-Auth for secure authentication.Enhanced UX with loading states, error handling, and real-time interactions.",
        stack: [
            { name: "Next" }, { name: "react" }, { name: "Talwand" },
        ],
        image: "/assets/work/image.png",
        live: "https://sahtak-ai.vercel.app",
